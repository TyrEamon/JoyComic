...
void main() {
  testWidgets('about page shows identity, version, disclaimer, licenses, and GitHub',
      (tester) async {
    Uri? launched;
  ...
  testWidgets('about route is real and diagnostics action navigates', (tester) async {
